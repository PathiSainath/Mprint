...
const BrochuresPage = () => {
  ...
  const getProductImageUrl = (product) => {
    ...
    return "https://via.placeholder.com/400x400?text=Brochures";
  };
  ...
  const renderStarRating = (rating) => {
    ...
    for (let i = 0; i < fullStars; i++) {
      stars.push(<FaStar key={i} className="text-orange-400" size={14} />);
    }
    ...
    return (
      <div className="min-h-screen bg-gray-50 py-16 px-6">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-gray-600">Loading brochure products...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="mb-10">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-lg text-gray-600 mb-2">
            Professional letterheads, notebooks, and custom office supplies for your business
          </p>
          <p className="text-sm text-blue-600">
            Same day delivery • Premium paper quality • Corporate branding • Bulk discounts
          </p>
        </div>
      </div>
        ...
        <div className="bg-white rounded-lg shadow-sm p-6">
          <div className="grid grid-cols-3 gap-4 text-center">
            <div>
              ...
              <p className="text-sm text-gray-600">Brochure Items</p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">Branding Available</p>
            </div>
          </div>
        </div>
      </div>
          ...
          {products.map((product) => {
            ...
            return (
              <div key={product.id} className="group">
                <Link to={`/brochures/${product.slug}`}>
                  <div className="bg-white rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 relative overflow-hidden">
                    ...
                    <div className="aspect-square overflow-hidden">
                      <img
                        ...
                        onError={(e) => {
                          e.target.src = "https://via.placeholder.com/400x400?text=Brochures";
                        }}
                      />
                    </div>
                    <div className="p-5">
                      ...
                      <p className="text-sm text-gray-600 mb-3">
                        Same Day Delivery - Mumbai, Bengaluru & Hyderabad
                      </p>
                      ...
                      <div className="flex items-center justify-between">
                        <div>
                          <p className="text-sm text-gray-600">10 starting at</p>
                        ...
                        {product.stock_quantity !== undefined && (
                          <span
                            className={`text-xs px-2 py-1 rounded-full ${parseInt(product.stock_quantity) > 0
