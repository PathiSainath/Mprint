...
const CardsPage = () => {
  ...
  const fetchCardsProducts = async () => {
    ...
    try {
      ...
      const response = await fetch(`${API_BASE_URL}/products/category/cards?${params}`, {
        method: "GET",
        headers: {
          ...
          <div className="flex-1">
            {products.length === 0 ? (
              <div className="text-center py-16 bg-white rounded-lg shadow-md">
                ...
                <h3 className="text-2xl font-semibold text-gray-800 mb-4">No Card Products Found</h3>
